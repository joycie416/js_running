...
console.log(1, arr.map(val => val*10));
...
// 5의 배수를 찾아 반환해주세요
// 결과값 [10]을 출력해주세요
console.log(2, arr.filter(val => val%5 === 0));
...
console.log(4, arr.filter(str => str.length >= 4));
 
 
// 5./
var arr = ["banana", "kiwi", "mango", "strawberry", "lime", "orange", "plum", "cherry"];
// 요소의 문자열 길이가 홀수인 요소만 반환하여 출력해주세요
console.log(5, arr.filter(str => str.length%2 === 1));
...
console.log(7, student.sort((a, b) => b.age - a.age));
...
console.log(11, arr.some(num => num<0));

// 12.
var arr = [1, 5, -3, 10, 0, 8];
// 모든 숫자가 음수인지 판별하는 코드를 작성하고 반환값을 출력해주세요
console.log(12, arr.every(num => num<0));